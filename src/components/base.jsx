...
const Story = () => {
    ...
    return ( 
        ...
        {current && (
            ...
            <div style={{backgroundImage: `url(${current.image})`}} className={"flex flex-col text-2xl font-sans gap-4 justify-center items-center bg-center w-full h-screen"}>
                <div className="flex flex-col font-black border-2 border-dotted rounded-lg gap-4 justify-center items-center box-decoration-slice bg-gradient-to-r from-[#00E5F5] to-[#F58E00] text-black px-2 w-45 container-fliud">
                    <p>{current.text}</p>
                </div>
